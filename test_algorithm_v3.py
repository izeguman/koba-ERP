...
def test_pallet_logic_v3():
    print("=== Pallet Loading Algorithm Test v3 (Overhang Prevention) ===")
    
    # 38-101A (530x250) -> 2x4 = 1060x1000
    # MOD 시리즈 (500x400) -> 2x2 = 1000x800 (OK), 2x3 = 1000x1200 (NO)
    items = [
